...
(assert (forall ((?A (_ BitVec 32)) (?B (_ BitVec 32)) (?C (_ BitVec 32)) (?D (_ BitVec 32)) (?E (_ BitVec 32)) (?F (_ BitVec 32)) )(let (($x21990 (|transition-2| (_ bv2 32) ?F (_ bv1 32) ?E ?D ?C false false ?B ?A)))
(=> (and (= ?A (bvneg (_ bv1 32))) (= ?B (bvneg (_ bv1 32)))) $x21990)))
)
...
(assert (forall ((?A (_ BitVec 32)) (?B (_ BitVec 32)) (?C (_ BitVec 32)) (?D (_ BitVec 32)) (?E (_ BitVec 32)) (?F Bool) (?G (_ BitVec 32)) (?H (_ BitVec 32)) (?I (_ BitVec 32)) )(let (($x8576 (and (|transition-2| (_ bv1 32) ?I ?G ?E ?D ?C false ?F ?B ?A) (or (not (= ?E (_ bv1 32))) (not ?F)))))
(=> $x8576 (|transition-2| (_ bv0 32) ?H ?G ?E ?D ?C false ?F ?B ?A))))
)
(assert (forall ((?A (_ BitVec 32)) (?B (_ BitVec 32)) (?C (_ BitVec 32)) (?D (_ BitVec 32)) (?E (_ BitVec 32)) )(let (($x24406 (|transition-0| (_ bv0 32) ?E ?D ?C false)))
(=> (|transition-1| (_ bv0 32) ?E ?D ?C ?B false ?A) $x24406)))
)
(assert (forall ((?A (_ BitVec 32)) (?B (_ BitVec 32)) (?C (_ BitVec 32)) (?D (_ BitVec 32)) (?E (_ BitVec 32)) (?F Bool) (?G (_ BitVec 32)) (?H (_ BitVec 32)) (?I (_ BitVec 32)) (?J (_ BitVec 32)) )(let (($x24406 (|transition-0| (_ bv0 32) ?J ?I ?H false)))
(let (($x23808 (and (|transition-2| (_ bv0 32) ?J ?I ?H ?D ?C false ?F ?B ?A) (= ?G ?D) (= ?E ?B))))
(=> $x23808 $x24406))))
)
