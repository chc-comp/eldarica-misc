...
(assert (forall ((A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)))(=> (and (= C (bvneg (_ bv50 32))) (h1 A B E D)) (h2 A B C D))))
...
(assert (forall ((A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)))(=> (and (bvsle C (bvneg (_ bv1 32))) (h6 A B C D)) (h7 A B C D))))
(assert (forall ((A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)))(=> (and (and (= E (bvsub (bvadd (_ bv1 32) C) D)) (= F (bvadd (bvneg (_ bv1 32)) D))) (h7 A B E F)) (h8 A B C D))))
(assert (forall ((A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)))(=> (and (bvsge C (_ bv0 32)) (h6 A B C D)) (h9 A B C D))))
...
(assert (forall ((A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)))(=> (and (bvsle D (_ bv0 32)) (h12 A B C D)) (h13 A B C D))))
(assert (not (exists ((A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)))(h13 A B C D))))
(assert (forall ((A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)))(=> (and (bvsge D (_ bv1 32)) (h12 A B C D)) (h14 A B C D))))
(assert (forall ((A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)))(=> (h14 A B C D) (h15 A B C D))))
