...
(assert (not (exists ((A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)))(and (and (and (and (and (and (not (= (bvadd A B) (bvadd (bvadd (bvadd C (bvneg (_ bv1 32))) C) D))) (= (bvadd A (bvneg (_ bv1 32))) E)) (= (bvadd C (bvneg (_ bv2 32))) F)) (REC_f_f E B F D)) (not (bvsle C (_ bv1 32)))) (not (bvsle A (_ bv1 32)))) (= A C)))))
