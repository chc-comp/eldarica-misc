...
(assert (not (exists ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int))(and (and (and (and (and (and (and (and (and (and (not (= A B)) (= (+ C (- 1)) D)) (= (+ E 1) F)) (= (+ G (- 1)) H)) (= (+ I 1) J)) (REC_f_f D F A H J B)) (not (= (+ G (- 1)) 0))) (not (= G 0))) (not (= C 0))) (= C G)) (= E I)))))
...
(assert (not (exists ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int))(and (and (and (and (and (and (and (and (not (= A B)) (= (+ C (- 1)) D)) (= (+ E 1) F)) (REC__f D F B)) (not (= (+ C (- 1)) 0))) (not (= C 0))) (= G 0)) (= G C)) (= A E)))))
