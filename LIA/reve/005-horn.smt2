...
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int)) (not (and (and (and (and (and (and (and (not (= A B)) (not (>= C D))) (not (>= E F))) (INV2 E F A C D B)) (not (>= G H))) (not (>= I J))) (INV1 G H K I J L)) (= M N)))))
