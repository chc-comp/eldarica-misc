...
(assert (not (exists ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int))(and (and (and (and (and (and (and (not (= A B)) (not (>= C D))) (not (>= E F))) (INV2 E F A C D B G H)) (not (>= I J))) (not (>= K L))) (INV1 I J M K L N G H)) (= G H)))))
