...
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Int) (S Int) (T Int)) (not (and (and (and (and (and (and (and (and (and (and (not (= A B)) (not (>= C D))) (not (>= E F))) (INV3 C D A E F B G H)) (not (>= I J))) (not (>= K L))) (INV2 K L M I J N G H)) (not (>= O P))) (not (>= Q R))) (INV1 O P S Q R T G H)) (= G H)))))
