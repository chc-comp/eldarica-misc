...
(assert (not (exists ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int))(and (and (and (and (not (= (+ (* 2 A) (* (- 2) B)) 0)) (not (<= A 9))) (not (>= (+ (- 10 B) (- 1)) 0))) (INV1 C A D E F G B H)) (= I J)))))
