...
(assert (not (exists ((A Int) (B Int))(and (and (and (and (and (not (= (* (- 1) A) 0)) (not (<= A (- 1)))) (not (>= (+ (+ A (- 1)) (- 1)) 0))) (<= B (- 1))) (not (>= (+ B (- 1)) 0))) (= B A)))))
(assert (not (exists ((A Int) (B Int) (C Int) (D Int))(and (and (and (and (and (and (and (not (= (* (- 1) (+ A 2)) 0)) (not (<= (+ A 2) (- 1)))) (= (+ B (- 2)) C)) (REC__f C A)) (>= (+ (+ B (- 1)) (- 1)) 0)) (<= D (- 1))) (not (>= (+ D (- 1)) 0))) (= D B)))))
(assert (not (exists ((A Int) (B Int))(and (and (and (and (and (not (= (+ A 0) 0)) (<= B (- 1))) (not (>= (+ (+ B (- 1)) (- 1)) 0))) (not (<= A (- 1)))) (not (>= (+ A (- 1)) 0))) (= A B)))))
(assert (not (exists ((A Int) (B Int))(and (and (and (and (and (not (= A B)) (not (<= B (- 1)))) (not (>= (+ (+ B (- 1)) (- 1)) 0))) (not (<= A (- 1)))) (not (>= (+ A (- 1)) 0))) (= A B)))))
(assert (not (exists ((A Int) (B Int) (C Int) (D Int))(and (and (and (and (and (and (and (not (= A (+ B 2))) (not (<= (+ B 2) (- 1)))) (= (+ C (- 2)) D)) (REC__f D B)) (>= (+ (+ C (- 1)) (- 1)) 0)) (not (<= A (- 1)))) (not (>= (+ A (- 1)) 0))) (= A C)))))
(assert (not (exists ((A Int) (B Int) (C Int) (D Int))(and (and (and (and (and (and (and (not (= (+ A 0) 0)) (<= (+ B 2) (- 1))) (= (+ C (- 2)) D)) (REC__f D B)) (>= (+ (+ C (- 1)) (- 1)) 0)) (not (<= A (- 1)))) (not (>= (+ A (- 1)) 0))) (= A C)))))
(assert (not (exists ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int))(and (and (and (and (and (and (and (and (not (= (+ (+ A 1) 0) 0)) (not (<= (+ A 1) (- 1)))) (<= (+ B 2) (- 1))) (= (+ C (- 1)) D)) (= (+ E (- 2)) F)) (REC_f_f D A F B)) (>= (+ (+ E (- 1)) (- 1)) 0)) (>= (+ C (- 1)) 0)) (= C E)))))
(assert (not (exists ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int))(and (and (and (and (and (and (and (and (not (= (+ A 1) (+ B 2))) (not (<= (+ A 1) (- 1)))) (not (<= (+ B 2) (- 1)))) (= (+ C (- 1)) D)) (= (+ E (- 2)) F)) (REC_f_f D A F B)) (>= (+ (+ E (- 1)) (- 1)) 0)) (>= (+ C (- 1)) 0)) (= C E)))))
(assert (not (exists ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int))(and (and (and (and (and (and (and (and (not (= (* (- 1) (+ A 2)) 0)) (<= (+ B 1) (- 1))) (not (<= (+ A 2) (- 1)))) (= (+ C (- 1)) D)) (= (+ E (- 2)) F)) (REC_f_f D B F A)) (>= (+ (+ E (- 1)) (- 1)) 0)) (>= (+ C (- 1)) 0)) (= C E)))))
(assert (not (exists ((A Int) (B Int) (C Int) (D Int))(and (and (and (and (and (and (and (not (= (+ A 1) B)) (not (<= (+ A 1) (- 1)))) (= (+ C (- 1)) D)) (REC_f_ D A)) (not (<= B (- 1)))) (not (>= (+ (+ B (- 1)) (- 1)) 0))) (>= (+ C (- 1)) 0)) (= C B)))))
(assert (not (exists ((A Int) (B Int) (C Int) (D Int))(and (and (and (and (and (and (and (not (= (* (- 1) A) 0)) (<= (+ B 1) (- 1))) (= (+ C (- 1)) D)) (REC_f_ D B)) (not (<= A (- 1)))) (not (>= (+ (+ A (- 1)) (- 1)) 0))) (>= (+ C (- 1)) 0)) (= C A)))))
(assert (not (exists ((A Int) (B Int) (C Int) (D Int))(and (and (and (and (and (and (and (not (= (+ (+ A 1) 0) 0)) (not (<= (+ A 1) (- 1)))) (= (+ B (- 1)) C)) (REC_f_ C A)) (<= D (- 1))) (not (>= (+ (+ D (- 1)) (- 1)) 0))) (>= (+ B (- 1)) 0)) (= B D)))))
