...
(assert (not (exists ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int))(and (and (and (and (and (and (not (= (+ A B) (+ (+ (+ C (- 1)) C) D))) (= (+ A (- 1)) E)) (= (+ C (- 2)) F)) (REC_f_f E B F D)) (not (<= C 1))) (not (<= A 1))) (= A C)))))
...
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))(=> (and (and (and (and (and (and (= (+ A E) B) (= (+ (+ (+ C (- 1)) C) F) D)) (= (+ A (- 1)) G)) (= (+ C (- 2)) H)) (REC_f_f G E H F)) (not (<= C 1))) (not (<= A 1))) (REC_f_f A B C D))))
