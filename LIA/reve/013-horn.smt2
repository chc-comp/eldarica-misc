...
(assert (not (exists ((A Int) (B Int) (C Int) (D Int))(and (and (and (and (and (and (not (= (+ A (+ A (- 1))) (+ (+ (+ B (- 1)) B) C))) (= (+ B (- 2)) D)) (REC__f D C)) (not (<= B 1))) (<= (+ A (- 1)) 1)) (not (<= A 1))) (= A B)))))
(assert (not (exists ((A Int) (B Int))(and (and (and (and (not (= (+ A (+ A (- 1))) B)) (<= B 1)) (<= (+ A (- 1)) 1)) (not (<= A 1))) (= A B)))))
(assert (not (exists ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int))(and (and (and (and (and (and (and (not (= (+ A (+ (+ A (- 1)) B)) (+ (+ (+ C (- 1)) C) D))) (= (+ (+ A (- 1)) (- 1)) E)) (= (+ C (- 2)) F)) (REC_f_f E B F D)) (not (<= C 1))) (not (<= (+ A (- 1)) 1))) (not (<= A 1))) (= A C)))))
(assert (not (exists ((A Int) (B Int) (C Int) (D Int))(and (and (and (and (and (and (not (= (+ A (+ (+ A (- 1)) B)) C)) (= (+ (+ A (- 1)) (- 1)) D)) (REC_f_ D B)) (<= C 1)) (not (<= (+ A (- 1)) 1))) (not (<= A 1))) (= A C)))))
(assert (not (exists ((A Int) (B Int))(and (and (and (not (= A B)) (<= B 1)) (<= A 1)) (= A B)))))
(assert (not (exists ((A Int) (B Int) (C Int) (D Int))(and (and (and (and (and (not (= A (+ (+ (+ B (- 1)) B) C))) (= (+ B (- 2)) D)) (REC__f D C)) (not (<= B 1))) (<= A 1)) (= A B)))))
