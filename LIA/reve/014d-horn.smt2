...
(assert (not (exists ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int))(and (and (and (and (and (and (and (not (= (+ (+ A B) (- 10)) 0)) (= (+ C (- 10)) 0)) (= (+ A (- 1)) D)) (= (+ C (- 1)) E)) (REC_f_f D B E F)) (not (<= C 1))) (not (<= A 0))) (= A C)))))
(assert (not (exists ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int))(and (and (and (and (and (and (and (not (= (+ A B) (+ C D))) (not (= (+ C (- 10)) 0))) (= (+ A (- 1)) E)) (= (+ C (- 1)) F)) (REC_f_f E B F D)) (not (<= C 1))) (not (<= A 0))) (= A C)))))
(assert (not (exists ((A Int) (B Int))(and (and (and (not (= A B)) (<= B 1)) (<= A 0)) (= A B)))))
(assert (not (exists ((A Int) (B Int) (C Int) (D Int))(and (and (and (and (and (and (not (= (+ A (- 10)) 0)) (= (+ B (- 10)) 0)) (= (+ B (- 1)) C)) (REC__f C D)) (not (<= B 1))) (<= A 0)) (= A B)))))
(assert (not (exists ((A Int) (B Int) (C Int) (D Int))(and (and (and (and (and (and (not (= A (+ B C))) (not (= (+ B (- 10)) 0))) (= (+ B (- 1)) D)) (REC__f D C)) (not (<= B 1))) (<= A 0)) (= A B)))))
