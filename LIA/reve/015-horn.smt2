...
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int)) (not (and (and (and (and (and (and (and (not (= (+ A B) (+ C D))) (>= D 0)) (= (+ A (- 1)) E)) (= (+ C (- 1)) F)) (REC_f_f E B F D)) (not (<= C 1))) (not (<= A 1))) (= A C)))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int)) (not (and (and (and (and (and (and (and (not (= (+ A B) C)) (not (>= C 0))) (= (+ A (- 1)) D)) (= (+ E (- 1)) F)) (REC_f_f D B F C)) (not (<= E 1))) (not (<= A 1))) (= A E)))))
(assert (forall ((A Int) (B Int)) (not (and (and (and (not (= A B)) (<= B 1)) (<= A 1)) (= A B)))))
(assert (forall ((A Int) (B Int) (C Int) (D Int)) (not (and (and (and (and (and (and (not (= A (+ B C))) (>= C 0)) (= (+ B (- 1)) D)) (REC__f D C)) (not (<= B 1))) (<= A 1)) (= A B)))))
(assert (forall ((A Int) (B Int) (C Int) (D Int)) (not (and (and (and (and (and (and (not (= A B)) (not (>= B 0))) (= (+ C (- 1)) D)) (REC__f D B)) (not (<= C 1))) (<= A 1)) (= A C)))))
