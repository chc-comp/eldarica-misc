...
(assert (not (exists ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))(and (and (and (and (and (and (not (= A B)) (not (>= C D))) (not (>= (+ (- E F) (- 1)) 0))) (INV3 C D A E F B)) (>= (+ (- 1 G) (- 1)) 0)) (not (>= (+ (- 1 H) (- 1)) 0))) (= H G)))))
...
(assert (not (exists ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))(and (and (and (and (and (and (not (= A B)) (not (>= C D))) (not (>= (+ (- E F) (- 1)) 0))) (INV4 C D A E F B)) (not (>= (+ (- 1 G) (- 1)) 0))) (not (>= (+ (- 1 H) (- 1)) 0))) (= H G)))))
...
(assert (not (exists ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))(and (and (and (and (and (and (not (= A B)) (not (>= C D))) (not (>= (+ (- E F) (- 1)) 0))) (INV1 C D A E F B)) (>= (+ (- 1 G) (- 1)) 0)) (>= (+ (- 1 H) (- 1)) 0)) (= H G)))))
...
(assert (not (exists ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))(and (and (and (and (and (and (not (= A B)) (not (>= C D))) (not (>= (+ (- E F) (- 1)) 0))) (INV2 C D A E F B)) (not (>= (+ (- 1 G) (- 1)) 0))) (>= (+ (- 1 H) (- 1)) 0)) (= H G)))))
