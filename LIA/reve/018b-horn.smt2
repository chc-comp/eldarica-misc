...
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int)) (not (and (and (and (and (and (and (not (= A B)) (not (>= C D))) (not (>= (+ (- E F) (- 1)) 0))) (INV3 C D A E F B G H)) (>= (+ (- 1 H) (- 1)) 0)) (not (>= (+ (- 1 G) (- 1)) 0))) (= G H)))))
...
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int)) (not (and (and (and (and (and (and (not (= A B)) (not (>= C D))) (not (>= (+ (- E F) (- 1)) 0))) (INV4 C D A E F B G H)) (not (>= (+ (- 1 H) (- 1)) 0))) (not (>= (+ (- 1 G) (- 1)) 0))) (= G H)))))
...
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int)) (not (and (and (and (and (and (and (not (= A B)) (not (>= C D))) (not (>= (+ (- E F) (- 1)) 0))) (INV1 C D A E F B G H)) (>= (+ (- 1 H) (- 1)) 0)) (>= (+ (- 1 G) (- 1)) 0)) (= G H)))))
...
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int)) (not (and (and (and (and (and (and (not (= A B)) (not (>= C D))) (not (>= (+ (- E F) (- 1)) 0))) (INV2 C D A E F B G H)) (not (>= (+ (- 1 H) (- 1)) 0))) (>= (+ (- 1 G) (- 1)) 0)) (= G H)))))
