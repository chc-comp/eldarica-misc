...
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int)) (not (and (and (and (and (and (and (and (not (= A B)) (REC_f_f C A D B)) (= (+ E 11) F)) (= (+ 11 G) H)) (REC_f_f F C H D)) (>= (+ (- 101 G) (- 1)) 0)) (not (>= (+ (+ E (- 100)) (- 1)) 0))) (= E G)))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int)) (not (and (and (and (and (and (and (not (= A (+ B (- 10)))) (REC_f_ C A)) (= (+ D 11) E)) (REC_f_ E C)) (not (>= (+ (- 101 B) (- 1)) 0))) (not (>= (+ (+ D (- 100)) (- 1)) 0))) (= D B)))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int)) (not (and (and (and (and (and (and (not (= (+ A (- 10)) B)) (REC__f C B)) (= (+ 11 D) E)) (REC__f E C)) (>= (+ (- 101 D) (- 1)) 0)) (>= (+ (+ A (- 100)) (- 1)) 0)) (= A D)))))
