...
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int))(=> (and (and (and (and (and (and (= (+ D (- 2)) B) (= (+ E 1) C)) (not (>= (+ (- F G) (- 1)) 0))) (>= (+ (- A E) (- 1)) 0)) (INV1 F H G A D E I J K L)) (= I K)) (= J L)) (INV3 A B C))))
...
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int))(=> (and (and (and (and (and (and (and (and (= (+ D 1) A) (= (+ E 2) B)) (>= (+ (- C D) (- 1)) 0)) (INV3 D E C)) (not (>= (+ (- F G) (- 1)) 0))) (>= (+ (- H I) (- 1)) 0)) (INV1 F J G H K I L M N O)) (= L N)) (= M O)) (INV3 A B C))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int))(=> (and (and (and (and (and (and (and (and (= (+ (+ K (- 2)) 1) B) (= (+ L 1) C)) (= (+ M (- 2)) E)) (= (+ N 1) F)) (>= (+ (- A L) (- 1)) 0)) (>= (+ (- D N) (- 1)) 0)) (INV1 A K L D M N G H I J)) (= G I)) (= H J)) (INV2 A B C D E F G H I J))))
...
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Int))(=> (and (and (and (and (and (and (and (and (and (= (+ K 1) D) (= (+ L 2) E)) (>= (+ (- F K) (- 1)) 0)) (not (>= (+ (- C A) (- 1)) 0))) (INV2 A B C K L F G H I J)) (>= (+ (- M N) (- 1)) 0)) (>= (+ (- O P) (- 1)) 0)) (INV1 M Q N O R P G H I J)) (= G I)) (= H J)) (INV2 A B C D E F G H I J))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Int) (S Int) (T Int))(=> (and (and (and (and (and (and (and (and (and (and (and (= (+ (+ K 2) (- 1)) A) (= (+ L 1) B)) (= (+ M 1) D)) (= (+ N 2) E)) (>= (+ (- F M) (- 1)) 0)) (>= (+ (- C K) (- 1)) 0)) (INV2 K L C M N F G H I J)) (>= (+ (- O P) (- 1)) 0)) (>= (+ (- Q R) (- 1)) 0)) (INV1 O S P Q T R G H I J)) (= G I)) (= H J)) (INV2 A B C D E F G H I J))))
...
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int)) (not (and (and (and (and (and (not (= A B)) (not (>= (+ (- C D) (- 1)) 0))) (not (>= (+ (- E F) (- 1)) 0))) (INV1 C A D E B F G H I J)) (= G I)) (= H J)))))
